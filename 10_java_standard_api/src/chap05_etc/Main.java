...
public class Main {
  ...
  public static void decimalFormat() {
     ...
     * 2. 천 단위 구분 기호(,), 소수 자리수 지정, 0 채우기 등 다양한 숫자 형식 지정에 사용됩니다.
     * 3. 주요 패턴 기호
     *    1) 0  빈자리를 0으로 채움
     *    2) #  빈자리는 표시하지 않음
     *    3) ,  천 단위 구분 기호
    ...
    System.err.println(df.format(1234.56));   // 1235 (자동 반올림)
    
    // 패턴 적용 후 확인 - 2
    df.applyPattern("0.00");                    // 소수 이하 2자리로 표기
    System.err.println(df.format(1234.567));   // 1234.57 (자동 반올림)
  ...
  public static void optional() {
    ...
    Optional<String> opt2 = Optional.ofNullable(str2); // null이 될 수 있는 값을 감싸는 경우 ofNulllable()을 사용합니다.
