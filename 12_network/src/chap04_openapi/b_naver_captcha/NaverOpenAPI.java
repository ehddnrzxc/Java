...
public class NaverOpenAPI {
  ...
  public final static String clientId = "qGZdfXAnJ7lIcC_pwWYg";
  public final static String clientSecret = "FTFa5_CGRQ";
...
//    System.err.println(sb.toString());  응답 JSON 문자열 확인
   ...
   * @param key 발급 받은 캡차 키
   */
  public static void validateInut(String key) throws Exception {
