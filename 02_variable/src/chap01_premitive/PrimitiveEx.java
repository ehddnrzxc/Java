...
public class PrimitiveEx {
  ...
  public static void main(String[] args) {
    ...
    /*
     * Primitive Type  boolean, int, long, double, char이 중요 byte(byte 배열 타입)는 애매
     * 1. 기본 타입을 의미합니다.
     * 2. 8가지 기본 타입이 있습니다.
     * 3. 오직 값만 저장하는 타입입니다.
    ...
    // Long 타입 주의점 (int 범위를 벗어나는 값의 리터럴 작성 시 마지막에 l 또는 L을 추가합니다. 통상적으로 L을 씀)
    d = 2137483648L;   System.out.println(d);
    }
    
    {
      // 실수 타입
      // 1. float  : 4바이트 (약 3.4e-38 ~ 3.4e+38) e:제곱
