...
//    try (InputStreamReader in = new InputStreamReader(new FileInputStream(file))) {   한글이 안깨지지만, 버퍼링이 없어서 성능(출력, 속도)이 떨어집니다.
    try (BufferedReader in = new BufferedReader(new InputStreamReader(new FileInputStream(file)))){
      ...
      */
      // BufferedReader를 사용하는 경우 아래와 같이 읽기를 추천합니다. (한 줄씩 읽기)
      String line = null;
      while((line = in.readLine()) != null) {
        sb.append(line).append("\n");
      }
