...
public class Main {
  ...
  public static void immutable() {
    ...
    seasons.set(1, "여름");  // 인덱스 1 요소 수정 (성공)
    seasons.set(2, "가을");  // 인덱스 2 요소 수정 (성공)
    seasons.set(3, "겨울");  // 인덱스 3 요소 수정 (성공)
  ...
  public static void sort() {
    ...
    Collections.sort(team, new Comparator<Person>() {
      ...
      public int compare(Person o1, Person o2) {
        // 이름순 정렬
        // String은 Comparable 인터페이스의 구현체이므로 comparTo() 메소드를 사용할 수 있습니다.
