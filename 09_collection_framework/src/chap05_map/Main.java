...
public class Main {
  ...
  public static void mutable() {
    ...
    if ( (boolean) map.get("isBestSeller") ) {    // Value의 타입은 Object 타입이므로
      System.out.println("베스트셀러 코너");       // Object 타입을 꺼내 쓰려면 casting이 필요함 (boolean 타입으로 casting함)
    } else {
  ...
  public static void immutable() {
    ...
    // immutable : 데이터 추가, 수정, 삭제가 불가능한 Map
    ...
    */
    ...
    // 데이터를 주고 받을 때 사용하면 좋습니다.
    // 1. Map을 인자로 전달하는 경우
    // 2. Map을 반환하는 경우
  }
  
  public static void travelsal() {
