 ...
 * 해시 테이블(Hash Table)
 * 
 * 1. 해시 함수를 이용해 데이터를 저장하고 검색하는 자료 구조(Data Structure)입니다.
...
public class Main {
  ...
  public static void hashSet() {
    ...
    // List 인터페이스와 동일하게 Collection 인터페이스를 구현했으나 인덱스 관련 사용은 불가능합니다. 향상 for문은 사용 가능
  ...
  public static void treeSet() {
    ...
    SortedSet<String> hobbies = new TreeSet<String>(); // 기본 생성 방식은 오름차순 정렬을 지원
